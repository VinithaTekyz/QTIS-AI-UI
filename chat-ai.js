Vue.component('cnx-chat-ai', {
	...
	<div id="cnx-chat-ai">    
		<div class="chat-ai">
			...
			<div v-show="showIcon"
				style="position: fixed; bottom: 40px; right: 40px; z-index: 9999; animation: fadeDark 2s infinite ease-in-out; border-radius: 50px;">
				<q-btn round size="lg"
			...
			<q-dialog v-model="showChat" persistent position="bottom-right" backdrop-filter="blur(4px)" transition-hide="fade"
				...
				<q-card
				style="width: 100%; max-width: 450px; border-radius: 20px; max-height: 90vh; display: flex; flex-direction: column;"
				class="q-pa-none">
				<div
