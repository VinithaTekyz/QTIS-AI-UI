		...
		<div :style="{
                ...
                <div style="
                    ...
                    <div style="
                        ...
                        padding: 8px 14px;
                        ">
                        <!-- Title on the left for chatai tenant with training mode-->
                        <div v-if="user.tenantId == 'chatai' style="display:flex; align-items:center; gap:5px;">
						...
						<!-- Title on the left without training mode for other tenants-->
                        <div v-if="user.tenantId != 'chatai' style="display:flex; align-items:center; gap:5px;">
                            <q-btn dense flat style="border-radius: 10px; padding-left: 15px; padding-right: 10px;"
                                :label="currentMode" color="black" size="md">
                                <q-menu auto-close transition-show="jump-down" transition-hide="jump-up">
                                    <q-list style="min-width:160px">
                                        <q-item clickable v-ripple @click="setMode('assistant')">
                                            <q-item-section>QTIS AI Assistant</q-item-section>
